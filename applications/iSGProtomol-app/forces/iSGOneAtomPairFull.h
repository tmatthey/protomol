/* -*- c++ -*- */
#ifndef ISGONEATOMPAIRFULL_H
#define ISGONEATOMPAIRFULL_H
...
namespace ProtoMol {
  //_________________________________________________________________ ISGOneAtomPairFull
  ...
  public:
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  public:
    iSGOneAtomPairFull(): switchingFunction(), nonbondedForceFunction(){};
    iSGOneAtomPairFull(TNonbondedForce nF,
		       TSwitchingFunction sF): 
      switchingFunction(sF), 
      nonbondedForceFunction(nF){};

    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // New methods of class ISGOneAtomPairFull
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  public:
    ...
    static iSGOneAtomPairFull make(std::string& errMsg, std::vector<Value> values) {
      unsigned int n = TNonbondedForce::getParameterSize();
      return iSGOneAtomPairFull(TNonbondedForce::make(errMsg,std::vector<Value>(values.begin(),values.begin()+n)),
  ...
  template<class TBoundaryConditions,
	   ...
	   class TNonbondedForce,
	   class TConstraint>
  inline void iSGOneAtomPairFull<TBoundaryConditions,
				 TSwitchingFunction,
				 TNonbondedForce,
