/* -*- c++ -*- */
#ifndef ISGIDEALGASCOULOMBFORCE_H
#define ISGIDEALGASCOULOMBFORCE_H
...
namespace ProtoMol {
  ...
  //_________________________________________________________________ iSGIdealGasCoulombForce
  ...
  public:
	...
	// do not compute if these are two different molecules
        if (M1 != M2) break;
    ...
    static iSGIdealGasCoulombForce make(std::string&, std::vector<Value>) {
      return iSGIdealGasCoulombForce();
    }
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // Sub Classes
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  public:
    ...
    public:
      ...
      static std::string getForceKeyword()            {return iSGIdealGasCoulombForce::keyword;}
    public:
