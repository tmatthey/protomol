/* -*- c++ -*- */
#ifndef ISGONEATOMPAIRTWOFULL_H
#define ISGONEATOMPAIRTWOFULL_H
...
namespace ProtoMol {
  ...
  //_____________________________________________________________ iSGOneAtomPairTwoFull
  ...
  public:
    ...
    iSGOneAtomPairTwoFull(TNonbondedForceFirst f1, 
  ...
  public:
    ...
    static iSGOneAtomPairTwoFull make(std::string& errMsg, std::vector<Value> values) {
      ...
      return iSGOneAtomPairTwoFull(TNonbondedForceFirst::make(errMsg,std::vector<Value>(values.begin(),values.begin()+l1)),			    
  ...
  template<class TBoundaryConditions,
	   ...
	   class TNonbondedForceSecond,
	   class TConstraint>
  inline void iSGOneAtomPairTwoFull<TBoundaryConditions,
