...
#endif
    ForceFactory::registerExemplar(new NonbondedSimpleFullSystemForce<OneAtomPairTwo<VacuumBoundaryConditions,ComplementSwitchingFunction<C2SwitchingFunction>,LennardJonesForce,ComplementSwitchingFunction<C1SwitchingFunction>,CoulombForceDiElec> >());
    ForceFactory::registerExemplar(new NonbondedSimpleFullSystemForce<OneAtomPairTwo<VacuumBoundaryConditions,ComplementSwitchingFunction<CnSwitchingFunction>,LennardJonesForce,ComplementSwitchingFunction<C1SwitchingFunction>,CoulombForceDiElec> >());
