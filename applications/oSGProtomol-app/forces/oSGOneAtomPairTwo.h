/* -*- c++ -*- */
#ifndef OSGONEATOMPAIRTWO_H
#define OSGONEATOMPAIRTWO_H
...
namespace ProtoMol {
  ...
  //_____________________________________________________________ oSGOneAtomPairTwo
  ...
  public:
    oSGOneAtomPairTwo(){}
    oSGOneAtomPairTwo(TNonbondedForceFirst f1, 
  ...
  public:
    ...
    static oSGOneAtomPairTwo make(std::string& errMsg, std::vector<Value> values) {
      ...
      return oSGOneAtomPairTwo(TNonbondedForceFirst::make(errMsg,std::vector<Value>(values.begin(),values.begin()+l1)),			    
  ...
  template<class TBoundaryConditions,
	   ...
	   class TNonbondedForceSecond,
	   class TConstraint>
  inline void oSGOneAtomPairTwo<TBoundaryConditions,
