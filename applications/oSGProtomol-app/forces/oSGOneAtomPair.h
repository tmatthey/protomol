/* -*- c++ -*- */
#ifndef OSGONEATOMPAIR_H
#define OSGONEATOMPAIR_H
...
namespace ProtoMol {
  //_________________________________________________________________ oSGOneAtomPair

  template<class TBoundaryConditions,
	   class TSwitchingFunction,
	   class TNonbondedForce,
	   class TConstraint=NoConstraint>
  class oSGOneAtomPair {
  ...
  public:
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  public:
    oSGOneAtomPair(): switchingFunction(), nonbondedForceFunction(){};
    oSGOneAtomPair(TNonbondedForce nF,
  ...
  public:
    ...
    static oSGOneAtomPair make(std::string& errMsg, std::vector<Value> values) {
      unsigned int n = TNonbondedForce::getParameterSize();
      return oSGOneAtomPair(TNonbondedForce::make(errMsg,std::vector<Value>(values.begin(),values.begin()+n)),
  ...
  template<class TBoundaryConditions,
	   ...
	   class TNonbondedForce,
	   class TConstraint>
  inline void oSGOneAtomPair<TBoundaryConditions,
			     TSwitchingFunction,
			     TNonbondedForce,
