/* -*- c++ -*- */
#ifndef OSGONEATOMPAIRTWOFULL_H
#define OSGONEATOMPAIRTWOFULL_H
...
namespace ProtoMol {
  ...
  //_____________________________________________________________ oSGOneAtomPairTwoFull
  ...
  public:
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  public:
    oSGOneAtomPairTwoFull(){}
    oSGOneAtomPairTwoFull(TNonbondedForceFirst f1, 
  ...
  public:
    ...
    static oSGOneAtomPairTwoFull make(std::string& errMsg, std::vector<Value> values) {
      ...
      return oSGOneAtomPairTwoFull(TNonbondedForceFirst::make(errMsg,std::vector<Value>(values.begin(),values.begin()+l1)),			    
  ...
  template<class TBoundaryConditions,
	   ...
	   class TNonbondedForceSecond,
	   class TConstraint>
  inline void oSGOneAtomPairTwoFull<TBoundaryConditions,
	...
	Real rawEnergy1, rawForce1, rawDeltaMu1, rawEnergy2, rawForce2, rawDeltaMu2;
        rawEnergy1 = rawEnergy2 = rawForce1 = rawForce2 = rawDeltaMu1 = rawDeltaMu2 = 0.0;
	Real rDistSquared = 1.0/distSquared;
	nonbondedForceFunctionFirst(rawEnergy1, rawForce1, rawDeltaMu1, distSquared, rDistSquared, diffMinimal, realTopo, i, j, excl);
	nonbondedForceFunctionSecond(rawEnergy2, rawForce2, rawDeltaMu2, distSquared, rDistSquared, diffMinimal, realTopo, i, j, excl);

	// Calculate the switched force and energy.
	Real energy1, force1, deltaMu1, energy2, force2, deltaMu2;
	if (TSwitchingFunctionFirst::USE || TSwitchingFunctionSecond::USE) {
	  ...
	  energy2 = rawEnergy2 * switchingValue2;
          deltaMu1 = rawDeltaMu1 * switchingValue1;
          deltaMu2 = rawDeltaMu2 * switchingValue2;
	  ...
	  energy1 = rawEnergy1;
	  energy2 = rawEnergy2;
          deltaMu1 = rawDeltaMu1;
          deltaMu2 = rawDeltaMu2;
	  force1 = rawForce1;
	  force2 = rawForce2;
	}
    ...
    for(unsigned int k=0;k<lattice->size();k++){
	  ...
	  && !switchingFunctionSecond.roughTest(distSquared))
	continue;
      // Calculate the force and energy and chemical potential difference.
      Real rawEnergy1, rawForce1, rawDeltaMu1, rawEnergy2, rawForce2, rawDeltaMu2;
      rawEnergy1 = rawEnergy2 = rawForce1 = rawForce2 = rawDeltaMu1 = rawDeltaMu2 = 0.0;
      Real rDistSquared = 1.0/distSquared;
      nonbondedForceFunctionFirst(rawEnergy1, rawForce1, rawDeltaMu1, distSquared, rDistSquared, diff, realTopo, i, j, EXCLUSION_NONE);
      nonbondedForceFunctionSecond(rawEnergy2, rawForce2, rawDeltaMu2, distSquared, rDistSquared, diff, realTopo, i, j, EXCLUSION_NONE);
