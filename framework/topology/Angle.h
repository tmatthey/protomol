...
namespace ProtoMol
{
	//_________________________________________________________________ Angle
	...
	class Angle
	{
		...
		//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	public:
		Angle(): atom1(-1), atom2(-1), atom3(-1), restAngle(0.0), forceConstant(0.0),
		         ureyBradleyConstant(0.0), ureyBradleyRestLength(0.0),
		         iSGmodifierIndex(0), DeltaK(0.0), DeltaTheta0(0.0), Delta_ubK(0.0), Delta_ubR0(0.0)
		{
		}
