...
namespace ProtoMol
{
	...
	C1SwitchingFunction::C1SwitchingFunction(): myCutoff(0.0),
	                                            myCutoff2(0.0),
	                                            myCutoff_3(0.0),
	                                            my15Cutoff_1(0.0),
	                                            my05Cutoff_3(0.0),
	...
	C1SwitchingFunction::C1SwitchingFunction(Real cutoff): myCutoff(cutoff),
	                                                       myCutoff2(cutoff * cutoff),
	                                                       myCutoff_3(1.0 / (cutoff * cutoff * cutoff)),
	                                                       my15Cutoff_1(1.5 / cutoff),
	...
	{
		parameters.push_back(Parameter("-cutoff", Value(myCutoff, ConstraintValueType::Positive()), Text("C1 swf cutoff")));
	}
	...
	Matrix3by3 C1SwitchingFunction::hessian(const Vector3D& rij, Real a) const
	{
		...
		return (Matrix3by3(tm3, 0, 0, 0, tm3, 0, 0, 0, tm3) + Matrix3by3(rij, rij / a) * tm4);
	}
}
