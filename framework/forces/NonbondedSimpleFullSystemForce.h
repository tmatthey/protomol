...
namespace ProtoMol {
  //_________________________________________________________________ NonbondedSimpleFullSystemForce

  template<class TOneAtomPair>
  class NonbondedSimpleFullSystemForce: public SystemForce, private NonbondedSimpleFullSystemForceBase {
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // Typedef
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  private:
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  public:
    NonbondedSimpleFullSystemForce(): SystemForce(),myBlockSize(0),myCached(false){}; 
    NonbondedSimpleFullSystemForce(TOneAtomPair oneAtomPair, unsigned int blockSize = defaultBlockSize) : 
...
// 		    int i0, int i1, int j0, int j1);
  ...
  public:
    virtual void evaluate(const GenericTopology* topo, 
			  ...
			  Vector3DBlock* f, 
			  ScalarStructure* e){ myCached = true;doEvaluate(topo,pos,f,e,0,topo->atoms.size(),0,topo->atoms.size());}
  ...
  private:
    virtual Force* doMake(std::string& errMsg, std::vector<Value> values) const{
      ...
      return (new NonbondedSimpleFullSystemForce(TOneAtomPair::make(errMsg,std::vector<Value>(values.begin(),values.end()-1)),
						blockSize));
    }
  ...
  template<class TOneAtomPair>
  void NonbondedSimpleFullSystemForce<TOneAtomPair>::doEvaluate(const GenericTopology* topo, 
...
//   template<class TOneAtomPair>
//   void NonbondedSimpleFullSystemForce<TOneAtomPair>::doEvaluate(GenericTopology* topo, 
// 								      const Vector3DBlock* positions, 
// 								      Vector3DBlock* forces, 
// 								      ScalarStructure* energies, 
// 								      int i0, int i1, int j0, int j1) {
