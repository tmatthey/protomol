...
namespace ProtoMol {
  //_________________________________________________________________ MTorsionSystemForce
  ...
  template<class TBoundaryConditions> 
  inline void MTorsionSystemForce<TBoundaryConditions>::calcTorsion(const TBoundaryConditions &boundary,
...
//     Report::report <<currTorsion.multiplicity;
//     for(unsigned int i=0;i<currTorsion.forceConstant.size();++i)
//       Report::report <<","<<currTorsion.forceConstant[i]
...
//     Report::report << Report::endr;
  ...
  template<class TBoundaryConditions> 
  inline Real MTorsionSystemForce<TBoundaryConditions>::calcTorsionEnergy(const TBoundaryConditions &boundary,
									  const Torsion& currTorsion,
									  const Vector3DBlock* positions){
    int a1 = currTorsion.atom1;
    int a2 = currTorsion.atom2;
