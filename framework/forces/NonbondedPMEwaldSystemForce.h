...
namespace ProtoMol
{
	...
	class NonbondedPMEwaldSystemForce: public SystemForce, private NonbondedPMEwaldSystemForceBase
	{
		//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		// Typedef
		//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	public:
		...
		{
			return (TBoundaryConditions::PERIODIC ? 7 : 8);
		}
	                                                                 ...
	                                                                 const Vector3DBlock* positions)
	{
		...
		if (TBoundaryConditions::VACUUM)
		{
				...
				d2.x <= d1.x || d2.y <= d1.y || d2.z <= d1.z)
			{
				...
				boundaryConditions.set(Vector3D(e.x, 0, 0),
				                       Vector3D(0, e.y, 0),
				                       Vector3D(0, 0, e.z),
				                       origin);
