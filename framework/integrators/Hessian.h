...
namespace ProtoMol
{
	...
	public:
		...
		void evaluateCoulombSCPISM(const Vector3DBlock* myPositions, const GenericTopology* myTopo, bool mrw);
		void evaluateCoulombBornRadii(const Vector3DBlock* myPositions, const GenericTopology* myTopo, bool mrw);
