...
namespace ProtoMol {
  ...
  */
  ...
  public:
    ...
    virtual XSC & getXSC() const { XSC *xsc = new XSC; return( *xsc ); }
  ...
  public:
    ...
    bool anyPreDriftOrNextModify()  const {return !myPreDriftOrNextModifiers.empty();};
    bool anyPostDriftOrNextModify() const {return !myPostDriftOrNextModifiers.empty();};
