		...
		if (myImproper)
		{
			...
			for (unsigned int i = 0; i < myTopo->impropers.size(); i++)
			{
				...
				if (nonZForce)
				{
					...
					int aout[4];
					aout[0] = myTopo->impropers[i].atom1;
					aout[1] = myTopo->impropers[i].atom2;
					aout[2] = myTopo->impropers[i].atom3;
					aout[3] = myTopo->impropers[i].atom4;
					//
		...
		if (myDihedral)
		{
			...
			for (unsigned int i = 0; i < myTopo->dihedrals.size(); i++)
			{
				...
				if (nonZForce)
				{
					...
					int aout[4];
					aout[0] = myTopo->dihedrals[i].atom1;
					aout[1] = myTopo->dihedrals[i].atom2;
					aout[2] = myTopo->dihedrals[i].atom3;
					aout[3] = myTopo->dihedrals[i].atom4;
					//
