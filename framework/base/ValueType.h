...
namespace ProtoMol
{
	...
	struct ValueTraits<std::string>
	{
		...
		static unsigned int size(const RepType& v)
		{
			return v.size();
		}
		...
		static bool check(const ConstraintValueType::NoConstraints&, const RepType&)
		{
			return true;
		}

		static bool check(const ConstraintValueType::NotEmpty&, const RepType& v)
		{
			return (v != "");
		}
	};
	...
	struct ValueTraits<int>
	{
		...
		static unsigned int size(RepType)
		{
			return 1;
		}
		...
		static bool check(const ConstraintValueType::Zero&, RepType v)
		{
			return (v == 0);
		}

		static bool check(const ConstraintValueType::NotZero&, RepType v)
		{
			return (v != 0);
		}

		static bool check(const ConstraintValueType::Positive&, RepType v)
		{
			return (v > 0);
		}

		static bool check(const ConstraintValueType::Negative&, RepType v)
		{
			return (v < 0);
		}

		static bool check(const ConstraintValueType::NotPositive&, RepType v)
		{
			return (v <= 0);
		}

		static bool check(const ConstraintValueType::NotNegative&, RepType v)
		{
			return (v >= 0);
		}
	};
	...
	struct ValueTraits<Vector3D>
	{
		...
		static unsigned int size(const RepType&)
		{
			return 3;
		}
	...
	struct ValueTraits<std::vector<Real>>
	{
		...
		static bool check(const ConstraintValueType::Empty&, const RepType& v)
		{
			return (v.empty());
		}
		...
		static bool check(const ConstraintValueType::Zero&, const RepType& v)
		{
			for (unsigned int i = 0; i < v.size(); i++) if (v[i] != 0.0) return false;
			return true;
		}
		...
		static bool check(const ConstraintValueType::Positive&, const RepType& v)
		{
			for (unsigned int i = 0; i < v.size(); i++) if (v[i] <= 0.0) return false;
			return true;
		}

		static bool check(const ConstraintValueType::Negative&, const RepType& v)
		{
			for (unsigned int i = 0; i < v.size(); i++) if (v[i] >= 0.0) return false;
			return true;
		}

		static bool check(const ConstraintValueType::NotPositive&, const RepType& v)
		{
			for (unsigned int i = 0; i < v.size(); i++) if (v[i] > 0.0) return false;
			return true;
		}

		static bool check(const ConstraintValueType::NotNegative&, const RepType& v)
		{
			for (unsigned int i = 0; i < v.size(); i++) if (v[i] < 0.0) return false;
			return true;
		}
