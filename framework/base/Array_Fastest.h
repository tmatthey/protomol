...
namespace ProtoMol
{
	...
	protected:
		...
		RefArray<T, N>()
			: RefArray<T, N - 1>(),
			  m_NDimensions(0), m_SubArrayLen(0), m_pElements(NULL)
		{
		}
		                     ...
		                     const size_type* pSubArrayLen)
		{
			...
			RefArray<T, N - 1>::SetupDimensions(pNDimensions + 1, pSubArrayLen + 1);
		}
	...
	public:
      ...
      m_boolDummy = (m_pElements != NULL);
		...
		{
			return m_NDimensions * m_SubArrayLen;
		}
...
#else
      bool resize(const size_t Dimensions[], const T & Init=T(), bool PreserveElems=false)
#endif
		{
...
#else
      bool doResize(const size_t Dimensions[], const T & Init=T(), bool PreserveElems=false)
#endif

		{
			...
			Temp.m_TheSubArray.SetupDimensions(Temp.m_NDimensions + 1, Temp.m_SubArrayLen + 1);
