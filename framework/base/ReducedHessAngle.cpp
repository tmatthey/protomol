...
namespace ProtoMol
{
	                                ...
	                                bool computeReduced)
	{
		...
		H[0][0] += rij_ij * FourEccFF - (rij_ki + rij_ki.transposed()) * FourEccFH + rki_ki * FourEccHH;
		H[0][2] += rij_kj * FourEccFG + rij_ki * FourEccFH - rki_kj * FourEccGH - rki_ki * FourEccHH;
		H[2][2] += rjk_jk * FourEccGG + (rki_kj + rki_kj.transposed()) * FourEccGH + rki_ki * FourEccHH;
		...
		if (!computeReduced)
		{
			...
			H[0][1] += rij_ki.transposed() * FourEcFc + rki_kj * FourEcGc - rij_ij * FourEcFa - rij_kj * FourEcFb;
			H[1][1] += rij_ij * FourEcFa + (rij_kj + rij_kj.transposed()) * FourEcFb + rjk_jk * FourEcGb;
			H[1][2] -= rjk_jk * FourEcGb + rij_kj * FourEcFb + rij_ki * FourEcFc + rki_kj.transposed() * FourEcGc;

			H[0][1] += rki_kj * FourEccGH - rij_kj * FourEccFG + rij_ki.transposed() * FourEccFH - rij_ij * FourEccFF;
			H[1][1] += rij_ij * FourEccFF + (rij_kj + rij_kj.transposed()) * FourEccFG + rjk_jk * FourEccGG;
			H[1][2] -= rij_kj * FourEccFG + rij_ki * FourEccFH + rki_kj.transposed() * FourEccGH + rjk_jk * FourEccGG;
	...
	void ReducedHessAngle::convertFromJacobian(Real** jac, int n)
	{
		...
		{ // assume n=6 holding 0,0; 0,2; 2,0; 2,2
