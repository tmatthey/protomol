...
namespace ProtoMol
{
	...
	public:
		...
		{
			return T::str[static_cast<int>(myType)];
		}
		...
		bool valid() const
		{
			return (myType > T::FIRST && myType < T::LAST);
		}

		static bool valid(Enum e)
		{
		...
		{
			return T::str[static_cast<int>(e)];
		}
	...
	private:
		...
		static const std::string& getString(int n)
		{
			return T::str[static_cast<int>(getEnum(n))];
		}
		...
		//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	public:
		friend Report::MyStreamer& operator<<(Report::MyStreamer& OS, const AbstractEnumType& b)
		{
	...
	typename AbstractEnumType<T, noCase>::Enum AbstractEnumType<T, noCase>::getEnum(const std::string& s)
	{
	...
	template <typename T, bool noCase>
	typename AbstractEnumType<T, noCase>::Enum AbstractEnumType<T, noCase>::getEnum(int n)
	{
	...
	template <typename T, bool noCase>
	std::string AbstractEnumType<T, noCase>::getPossibleValues(std::string separator)
	{
		std::string tmp = "";
		for (int i = static_cast<int>(T::FIRST) + 1; i < static_cast<int>(T::LAST); ++i)
		{
