...
namespace ProtoMol
{
	...
	bool AMBERReader::tryFormat()
	{ //tryFormat check file format
		if (!open())
			return false;
		else return true;
		//string topHead;
		//myFile >> topHead;
		//return (myFile.good() && equalNocase("AMBER",topHead));
	}
