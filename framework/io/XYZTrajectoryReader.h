...
namespace ProtoMol {
  ...
  public:
    ...
    virtual bool open(const std::string& filename){myFirst=true;return File::open(filename);}
    virtual bool open(const char* filename){myFirst=true;return File::open(filename);}
