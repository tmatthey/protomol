...
namespace ProtoMol {
  ...
  public:
    ...
    virtual bool open(const std::string& filename){myFirst = false;return File::open(filename);}
    virtual bool open(const char* filename){myFirst = false;return File::open(filename);}
