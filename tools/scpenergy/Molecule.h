...
namespace ProtoMol {
  //_________________________________________________________________ Molecule
  ...
  */
  struct Molecule {
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Molecule():mass(0.0),position(0.0,0.0,0.0),momentum(0.0,0.0,0.0),water(false),
               type(0),newtype(0),lambda(0.0) {}
